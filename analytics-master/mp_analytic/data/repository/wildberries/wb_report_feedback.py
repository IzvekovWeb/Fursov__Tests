...
class FeedbackReport:
    ...
    def execute(self):
        for supplier in self.__suppliers:
            ...
            self.get_nomenclatures(supplier_name,  wb_token, supplier_id)
            self.get_feedbacks(supplier_name, wb_token, supplier_id)

        return self.create_table()

    def get_feedbacks(self, supplier_name, wb_token, supplier_id):
    ...
    def get_nomenclatures(self, supplier_name,  wb_token, supplier_id):
        nomenclature_list = PersonalAccountAPI().get_nomenclatures(supplier_id,  wb_token)
