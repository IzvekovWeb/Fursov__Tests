...
class SellPercentReportBySize(object):
    ...
    def get_data_from_finance_report(self, finance_report):
        for order in finance_report:
            ...
            self.prepare_data(order_type, count, return_amount, article_color_size)

    def prepare_data(self, order_type, count, return_amount, article_color_size):
        ...
        self.percent(self.response_by_article_color_size, article_color_size,
                     orders, pay, return_amount, return_item, sell, percent)
    ...
    def create_table(self):
        ...
        self.collect_data(self.response_by_article_color_size, tables)
        return tables
