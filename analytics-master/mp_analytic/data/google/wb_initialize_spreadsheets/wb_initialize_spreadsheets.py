...
class WildberriesSpreadSheet(object):
    def __init__(self, sheets: dict, spreadsheet_title: str, spreadsheet_id: str) -> None:
        """
...
def is_multiple_header(headers: str | dict | list) -> list:
    if isinstance(headers, str | int):
        return [str(headers)]
...
def read_from_json(file: str) -> dict:
