...
<!--            </div>-->
          ...
          <div class="login-signup">
                    <span class="text">Нет аккаунта?
                        <a href="#" class="text signup-link" @click="addContainerActive">Регистрация</a>
                    </span>
          </div>
        </div>
        ...
        <div class="form signup">
          ...
          <form>
            <div class="input-field">
              <input type="text" placeholder="Имя" required v-model="userRegister.username">
            ...
            <div class="checkbox-text">
              <div class="checkbox-content">
                ...
                <label for="termCon" class="text">Я принимаю условия <a href="/rules" target="_blank" style="text-decoration: none">пользовательского соглашения и политики конфиденциальности</a></label>
              </div>
            </div>
            ...
            <div class="input-field button">
              <input type="button" value="Зарегистрироваться" @click="register">
            </div>
          </form>
          ...
          <div class="login-signup">
                    <span class="text">Есть аккаунт?
                        <a href="#" class="text login-link" @click="removeContainerActive">Войти</a>
                    </span>
          </div>
  ...
  methods: {
    ...
    register() {
      ...
      if (this.userRegister.password !== '' && this.userRegister.email !== '' && this.userRegister.username !== ''){
        AuthService.register(this.userRegister)
        this.alertSuccess("Успешная регистрация! Свяжитесь с менеджером")
      }
    },
    login() {
