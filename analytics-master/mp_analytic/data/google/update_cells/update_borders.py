...
class NotCorrectInputValuesException(Exception):
    pass


def update_borders(sheet_id: int | str, start_row: int | str, end_row: int | str,
                   start_column: int | str, end_column: int | str,
                   left: bool, right: bool, bottom: bool, top: bool,
                   width: int | str, style: str, color: dict, clear: bool):
    if clear:
