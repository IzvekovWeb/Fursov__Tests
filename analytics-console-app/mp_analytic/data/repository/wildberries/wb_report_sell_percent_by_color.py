...
class SellPercentByColorReport(object):
    ...
    def get_data_from_finance_report(self, finance_report):
        for order in finance_report:
            ...
            self.prepare_data(order_type, count, return_amount, article_color)
    ...
    def create_table(self):
        ...
        self.collect_data(self.response_by_article_color, tables)
        return tables
