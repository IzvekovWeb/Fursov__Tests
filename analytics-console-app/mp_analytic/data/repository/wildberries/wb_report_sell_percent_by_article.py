...
class SellPercentReportByArticle(object):
    ...
    def get_data_from_finance_report(self, finance_report):
        for order in finance_report:
            ...
            self.prepare_data(order_type, count, return_amount, article)

    def prepare_data(self, order_type, count, return_amount, article):
        ...
        self.percent(self.response_by_article, article, orders, pay,
                     return_amount, return_item, sell, percent)
    ...
    def create_table(self):
        ...
        self.collect_data(self.response_by_article, tables)
        return tables
